...
class TransE:
    ...
    def writeEntilyVector(self, dir):
        ...
        with open(dir, "w", newline='') as f:
            ...
            for entity in self.entityList.keys():
                ...
                lists.append([entity])
                #print (relation)
                lists.append(self.entityList[entity].tolist())
    ...
    def writeRelationVector(self, dir):
        ...
        with open(dir, "w", newline='') as f:
            ...
            for relation in self.relationList.keys():
                lists = []
                lists.append([relation])
                #print (relation)
                lists.append(self.relationList[relation].tolist())
                writer.writerow(lists)
        f.close()
...
if __name__ == '__main__':
    ...
    dirRelation = "./FB15K/relation2id.txt"
    relationIdNum, relationList = openDetailsAndId(dirRelation)
    dirTrain = "./FB15K/train.txt"
